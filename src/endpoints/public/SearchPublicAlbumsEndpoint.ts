...
export class SearchPublicAlbumsEndpoint extends GetEndpoint {
    db: TriDB;
    ...
    async run(req: any, res: Response) {
        ...
        const searchResults = await SearchEngine.search(this.db, SearchConfigurations.albums, request, true);
